...
export default function Header() {
    ...
    return (
        <header>
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-3 z-[1000] md:gap-[5vw] justify-between justify-items-center items-center w-screen h-[80px] bg-header shadow-[0px_8px_8px_rgba(0,0,0,0.10)]">
