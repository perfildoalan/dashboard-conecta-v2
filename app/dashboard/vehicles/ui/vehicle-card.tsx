...
const VehicleCard: React.FC<VehicleCardProps> = ({ id, color, brand, model, year, category, motor, onDelete, onEdit }) => {
    return (
        <div className='relative flex flex-col bg-white/30 backdrop-blur-sm gap-2 group rounded-2xl shadow-lg hover:shadow-2xl p-4 transition-all cursor-pointer'>
